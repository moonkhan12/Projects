...
String DHTTemperature; // The RTOS will ensure these readings are kept up to date.
String DHTHumidity;      // The rate at which the server updates itself is its own business.
...
void setup(){
  ...
  /*
  delay(3000); //Time for the clock to set itself up; if it is not set up...
  if (! rtc.begin()) 
  {
